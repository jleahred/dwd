...
var _user$project$BootstrapLayout$pageNotFound = {
	ctor: '::',
	_0: A2(
...
var _user$project$BootstrapLayout$pageModules = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$h1,
...
var _user$project$BootstrapLayout$pageHome = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$h1,
...
var _user$project$BootstrapLayout$Model = F3(
	function (a, b, c) {
		return {page: a, navState: b, modalState: c};
	});
var _user$project$BootstrapLayout$NotFound = {ctor: 'NotFound'};
var _user$project$BootstrapLayout$Modules = {ctor: 'Modules'};
var _user$project$BootstrapLayout$GettingStarted = {ctor: 'GettingStarted'};
var _user$project$BootstrapLayout$Home = {ctor: 'Home'};
var _user$project$BootstrapLayout$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$BootstrapLayout$Home, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$BootstrapLayout$GettingStarted,
				_evancz$url_parser$UrlParser$s('getting-started')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$BootstrapLayout$Modules,
					_evancz$url_parser$UrlParser$s('modules')),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$BootstrapLayout$decode = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _user$project$BootstrapLayout$routeParser, location);
};
var _user$project$BootstrapLayout$urlUpdate = F2(
	function (location, model) {
		var _p0 = _user$project$BootstrapLayout$decode(location);
		if (_p0.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{page: _user$project$BootstrapLayout$NotFound}),
...
var _user$project$BootstrapLayout$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UrlChange':
				return A2(_user$project$BootstrapLayout$urlUpdate, _p1._0, model);
			case 'NavMsg':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$BootstrapLayout$ModalMsg = function (a) {
	return {ctor: 'ModalMsg', _0: a};
};
var _user$project$BootstrapLayout$pageGettingStarted = function (model) {
	return {
		ctor: '::',
		_0: A2(
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$BootstrapLayout$ModalMsg(_rundis$elm_bootstrap$Bootstrap_Modal$visibleState)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$BootstrapLayout$mainContent = function (model) {
	return A2(
		...
		function () {
			...
			switch (_p2.ctor) {
				case 'Home':
					return _user$project$BootstrapLayout$pageHome(model);
				case 'GettingStarted':
					return _user$project$BootstrapLayout$pageGettingStarted(model);
				case 'Modules':
					return _user$project$BootstrapLayout$pageModules(model);
				default:
					return _user$project$BootstrapLayout$pageNotFound;
			}
		}());
};
var _user$project$BootstrapLayout$modal = function (model) {
	return A2(
		...
		A3(
			...
			A3(
				...
				_rundis$elm_bootstrap$Bootstrap_Modal$small(
					_rundis$elm_bootstrap$Bootstrap_Modal$config(_user$project$BootstrapLayout$ModalMsg)))));
};
var _user$project$BootstrapLayout$NavMsg = function (a) {
	return {ctor: 'NavMsg', _0: a};
};
var _user$project$BootstrapLayout$init = function (location) {
	var _p3 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$BootstrapLayout$NavMsg);
	var navState = _p3._0;
	var navCmd = _p3._1;
	var _p4 = A2(
		_user$project$BootstrapLayout$urlUpdate,
		location,
		{navState: navState, page: _user$project$BootstrapLayout$Home, modalState: _rundis$elm_bootstrap$Bootstrap_Modal$hiddenState});
	var model = _p4._0;
	var urlCmd = _p4._1;
	return {
		ctor: '_Tuple2',
...
var _user$project$BootstrapLayout$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Navbar$subscriptions, model.navState, _user$project$BootstrapLayout$NavMsg);
};
var _user$project$BootstrapLayout$menu = function (model) {
	return A2(
		...
		A2(
			...
			A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Elm Bootstrap'),
					_1: {ctor: '[]'}
				},
				_rundis$elm_bootstrap$Bootstrap_Navbar$container(
					_rundis$elm_bootstrap$Bootstrap_Navbar$withAnimation(
						_rundis$elm_bootstrap$Bootstrap_Navbar$config(_user$project$BootstrapLayout$NavMsg))))));
};
var _user$project$BootstrapLayout$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$BootstrapLayout$menu(model),
			_1: {
				ctor: '::',
				_0: _user$project$BootstrapLayout$mainContent(model),
				_1: {
					ctor: '::',
					_0: _user$project$BootstrapLayout$modal(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$BootstrapLayout$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$BootstrapLayout$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$BootstrapLayout$UrlChange,
	{view: _user$project$BootstrapLayout$view, update: _user$project$BootstrapLayout$update, subscriptions: _user$project$BootstrapLayout$subscriptions, init: _user$project$BootstrapLayout$init})();

var Elm = {};
Elm['BootstrapLayout'] = Elm['BootstrapLayout'] || {};
if (typeof _user$project$BootstrapLayout$main !== 'undefined') {
    _user$project$BootstrapLayout$main(Elm['BootstrapLayout'], 'BootstrapLayout', undefined);
}
